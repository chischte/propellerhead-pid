 ...
 * Using an ISR (interrupt service routine) to switch the signal for the ESC would make the program even a bit faster, but i prefer
 ...
 * V6
 * Angle of the gyro sensor decays to the angle value of the accelerometer instead of decaying to zero.
 ...
 *
 * V9
 * LET THE "PID REGULATOR" LOOP PERMANENTLY RUNNING (for debugging and monitoring), the analog read section
 ...
 * 1740 us !!! (up to) because of ongoing interrupt troubles and arduino crashes I
 * finally decided to program a ESC-control without interrupts. I did not help and
 * I lost over 1500us runtime! ...but also gained a much higher ESC actualization rate
